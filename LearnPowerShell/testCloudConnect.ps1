...
#Resource Group
$resourceGroupName = "myDemoBucket"
$location = "westus"
...
$storageAccountName = 'myDemoBucketstorage'
...
$containerName = 'myDemoBucketcontainer'
...
$setAzStorageBlobSplat = @{
    ...
    File      = 'C:\rs-pkgs\myDemoBucket_text_file.txt'
    Blob      = 'myDemoBucket_text_file.txt'
}
